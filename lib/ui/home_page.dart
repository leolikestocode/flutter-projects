...
class _HomePageState extends State<HomePage> {
  ...
  @override
  void initState() { //init state quando carregar pela primeira vez
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Contatos"),
        backgroundColor: const Color(0xff220B5E),
        centerTitle: true,
        actions: <Widget>[
      ...
      backgroundColor: const Color(0xff967ECB),
           ...
           return Container(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                FlatButton(
                  child: Text("Ligar",
                  style: TextStyle(color: const Color(0xff967ECB),
                  fontSize: 20.0)
                  ),
                  onPressed: (){
